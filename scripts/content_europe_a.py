...
n = build('spain', 'Spain',
  ...
  [
   ...
   ('Tenerife', 'tenerife',
    ['Mostly hotel and resort ceremonies, with a longer flight than the mainland or the Balearics and '
     'the cost consequence that follows. Worth being plain: for a resort ceremony at the more economical '
     'end of the island&rsquo;s market, flying a consort out will look disproportionate against the rest '
     'of the budget. Where the wedding is at the top end, it works as well as anywhere.']),
  ],
  [
